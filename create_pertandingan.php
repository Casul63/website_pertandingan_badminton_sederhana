...
if (isset($_POST['create_pertandingan'])) {
    ...
    $pemain_1 = $_POST['pemain_1'];
    $pemain_2 = $_POST['pemain_2'];
    $id_wasit = $_POST['wasit'];
    $waktu_mulai = $_POST['waktu_mulai'];
    $waktu_selesai = $_POST['waktu_selesai'];

    $sql_pertandingan = "INSERT INTO pertandingan (nama_pertandingan, waktu_mulai, waktu_selesai, id_wasit) VALUES ('$nama_pertandingan', '$waktu_mulai', '$waktu_selesai', $id_wasit);";
    ...
    $sql_pemain_pertandingan = "INSERT INTO pemain_pertandingan (id_pemain_1, id_pemain_2, id_pertandingan) 
                                VALUES ($pemain_1, $pemain_2, $id_pertandingan);";
