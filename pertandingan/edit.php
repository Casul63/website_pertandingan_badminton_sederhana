...
$nama_pertandingan = isset($row['nama_pertandingan']) ? $row['nama_pertandingan'] : '';
$pemain_1 = isset($row['nama_pemain_1']) ? $row['nama_pemain_1'] : '';
$pemain_2 = isset($row['nama_pemain_2']) ? $row['nama_pemain_2'] : '';
$wasit = isset($row['nama_wasit']) ? $row['nama_wasit'] : '';
$waktu_mulai = isset($row['waktu_mulai']) ? date('Y-m-d\TH:i', strtotime($row['waktu_mulai'])) : '';
$waktu_selesai = isset($row['waktu_selesai']) ? date('Y-m-d\TH:i', strtotime($row['waktu_selesai'])) : '';
