...
if (isset($_POST['create_pertandingan'])) {
    ...
    $sql_pertandingan = "INSERT INTO pertandingan (nama_pertandingan, waktu_mulai, waktu_selesai, id_wasit) VALUES ('$nama_pertandingan', '$waktu_mulai', '$waktu_selesai', NULL);";
    ...
    $sql_pemain_pertandingan = "INSERT INTO pemain_pertandingan (id_pemain_1, id_pemain_2, id_pertandingan) 
                                VALUES (NULL, NULL, $id_pertandingan);";
